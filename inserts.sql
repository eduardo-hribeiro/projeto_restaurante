...
-- INSERÇÃO DE CARGOS
select * from cargos;
INSERT INTO cargos (nome_cargo, nivel) VALUES
				   ('Gerente','Senior'),
...
INSERT INTO funcionarios (nome, cpf, data_nascimento, endereco, telefone, email, id_cargo, salario, data_admissao) VALUES
						 ('Ricardo Sousa','111.222.333-44','1992-05-12','Rua Harmonia 157, São Paulo','11987651234','ricardo.sousa@email.com',2,6000,'2019-03-15'),
						 ('Lívia Castro','222.333.444-55','1989-11-25','Av. Rebouças 1234, São Paulo','11987653421','livia.castro@email.com',4,5500,'2019-06-20'),
						 ('Marcos Lima','333.444.555-66','1985-04-17','Rua Augusta 2020, São Paulo','11987655678','marcos.lima@email.com',9,2800,'2020-01-10'),
						 ('Carla Mendes','444.555.666-77','1993-07-03','Av. Paulista 1853, São Paulo','11987659876','carla.mendes@email.com',6,2600,'2020-07-15'),
						 ('Tiago Nunes','555.666.777-88','1978-08-12','Rua Funchal 500, São Paulo','11987656789','tiago.nunes@email.com',10,3400,'2021-04-22'),
						 ('Cláudia Vieira','666.777.888-99','1981-01-19','Alameda Lorena 1300, São Paulo','11987657890','claudia.vieira@email.com',3,3200,'2021-08-30'),
						 ('Pedro Martins','777.888.999-00','1983-12-05','Rua dos Pinheiros 800, São Paulo','11987658901','pedro.martins@email.com',5,2700,'2022-03-15'),
						 ('Fernanda Rocha','888.999.000-11','1990-09-27','Av. Faria Lima 1500, São Paulo','11987659012','fernanda.rocha@email.com',6,2700,'2022-05-20'),
						 ('André Costa','999.000.111-22','1986-03-14','Rua Bela Cintra 985, São Paulo','11987660123','andre.costa@email.com',1,4700,'2022-10-10'),
						 ('Sofia Alves','000.111.222-33','1995-06-01','Rua Consolação 1235, São Paulo','11987661234','sofia.alves@email.com',8,2400,'2023-01-01');
...
select * from pedidos;
INSERT INTO pedidos (id_cliente, id_funcionario, data_pedido, status) VALUES
					(1, 4, '2024-07-01', 'Concluído'),
					(3, 4, '2024-07-01', 'Concluído'),
					(6, 7, '2024-07-01', 'Concluído'),
					(8, 7, '2024-07-01', 'Concluído'),
					(10, 8, '2024-07-02', 'Pendente'),
					(15, 8, '2024-07-02', 'Concluído'),
					(22, 4, '2024-07-02', 'Concluído'),
					(18, 4, '2024-07-02', 'Concluído'),
					(4, 7, '2024-07-02', 'Concluído'),
					(6, 7, '2024-07-03', 'Concluído'),
					(9, 8, '2024-07-03', 'Concluído'),
					(11, 8, '2024-07-03', 'Concluído'),
					(24, 4, '2024-07-03', 'Concluído'),
					(27, 4, '2024-07-03', 'Concluído'),
					(17, 7, '2024-07-03', 'Concluído'),
					(7, 7, '2024-07-04', 'Concluído'),
					(13, 8, '2024-07-04', 'Concluído'),
					(25, 8, '2024-07-04', 'Concluído'),
					(22, 4, '2024-07-04', 'Concluído'),
					(2, 4, '2024-07-04', 'Concluído'),
					(8, 7, '2024-07-04', 'Concluído'),
					(11, 7, '2024-07-05', 'Concluído'),
					(18, 8,'2024-07-05', 'Concluído'),
					(22, 8, '2024-07-05', 'Concluído'),
					(19, 4, '2024-07-05', 'Concluído'),
					(28, 4, '2024-07-05', 'Concluído'),
					(1, 7, '2024-07-05', 'Concluído'),
					(7, 7, '2024-07-05', 'Concluído'),
					(19, 8, '2024-07-05', 'Concluído'),
					(15, 8, '2024-07-05', 'Concluído'),
					(24, 4, '2024-07-05', 'Concluído'),
					(12, 4, '2024-07-05', 'Concluído'),
					(4, 7, '2024-07-05', 'Concluído'),
					(9, 7, '2024-07-06', 'Concluído'),
					(18, 8, '2024-07-06', 'Concluído'),
					(5, 8, '2024-07-06', 'Pendente'),
					(22, 4, '2024-07-06', 'Concluído'),
					(14, 4, '2024-07-06', 'Pendente'),
					(19, 7, '2024-07-06', 'Concluído'),
					(8, 7, '2024-07-06', 'Pendente'),
					(7, 8, '2024-07-06', 'Concluído'),
					(4, 8, '2024-07-06', 'Pendente'),
					(21, 4, '2024-07-06', 'Concluído'),
					(4, 4, '2024-07-06', 'Pendente'),
					(13, 7, '2024-07-06', 'Concluído'),
					(25, 7, '2024-07-06', 'Pendente'),
					(7, 8, '2024-07-06', 'Concluído'),
					(7, 8, '2024-07-06', 'Concluído'),
					(12, 4, '2024-07-06', 'Concluído'),
					(10, 4, '2024-07-06', 'Pendente');
