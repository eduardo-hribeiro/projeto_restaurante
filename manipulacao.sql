-- INSERÇÃO DE REGISTROS NA TABELA FUNCIONÁRIOS
...
-- INSERÇÃO DE REGISTROS NA TABELA INFO_PRODUTOS
...
-- ATUALIZAÇÃO DE CARGO DE FUNCIONÁRIOS
select * from funcionarios;
...
-- ATUALIZAÇÃO DE TODOS OS PEDIDOS COM A DATA MENOR QUE 2024-07-06 PARA CONCLUÍDO
select * from pedidos;
